...
}), $("footer").before('<div class="am-modal-actions" id="fenxiang"><div class="am-modal-actions-group"><ul class="am-list"><li class="am-modal-actions-header">分享本站给你的朋友</li><li><a target="_blank"><span class="am-icon-share-alt"></span> 分享到QQ空间</a></li><li><a target="_blank"><i class="am-icon-qq"></i> 分享到QQ</a></li></ul></div><div class="am-modal-actions-group"><button class="am-btn am-btn-secondary am-btn-block" data-am-modal-close>取消</button></div></div><div class="am-modal am-modal-alert" id="zanzhu"><div class="am-modal-dialog"><div class="am-modal-hd">如果您绝对不错，就赞助支持一下吧</div><div class="am-modal-bd"><ul class="am-avg-sm-2 am-thumbnails"><li><span>支付宝</span> <img class="am-thumbnail" src="https://s.ssss.fun/QR_Code/Reward-alipay.jpg"></li><li><span>微信</span> <img class="am-thumbnail" src="https://s.ssss.fun/QR_Code/Reward-wechat.jpg"></li></ul></div><div class="am-modal-footer"><span class="am-modal-btn">确定</span></div></div></div><a class="am-icon-btn am-icon-arrow-up am-active" id="go-to-top"></a>'), $("#fenxiang").on("open.modal.amui", function () {
